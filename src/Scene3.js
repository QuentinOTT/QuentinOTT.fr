  ...
  return (
    <>
      <group name="sceneContainer" ref={group}>
        ...
        <Title name="title" label="Developper WEB" position={[0, 4, -10]} color={PEDRO_COLOR} />
        <TitleCopies position={[0, 2, -5]} rotation={[0, 0, 0]} layers={[11]} label="Developper WEB"  color={PEDRO_COLOR} />

        <Title layers={[11]} name="title" label="Cliquez sur les cubes" position={[0, 2, 24]} scale={[-1, 1, 1]} color={CLICKHERE_COLOR} />
